...
add_action( 'widgets_init', 'presentup_flicker_widget' );

function presentup_flicker_widget() {
	register_widget( 'presentup_flicker_widget' );
}

class presentup_flicker_widget extends WP_Widget {
	...
	function __construct() {
		$widget_style = array('classname'   => 'presentup_flicker_widget',
							  'description' => esc_attr__('Show photos from Flickr.','presentup') );
		...
		$control_styles = array('width'   => 300,
								'height'  => 350,
								'id_base' => 'presentup_flicker_widget');
		...
		parent::__construct(
			'presentup_flicker_widget', // Base ID
			esc_attr__('Presentup Flickr Widget', 'presentup'), // Name
			$widget_style // Args
		);
	}
	...
	function widget( $args, $cur_instance ) {
		...
		echo '<div class="presentup_flicker_widget_wrapper">'; ?>
	...
	function form( $cur_instance ) {
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id( 'title' )); ?>"><?php echo esc_attr__('Title', 'presentup'); ?>:</label>
