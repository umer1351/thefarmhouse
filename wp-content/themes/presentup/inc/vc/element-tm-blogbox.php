...
$allParams = array_merge(
	...
	array(
		array(
			...
			"description" => esc_attr__("Show sortable category links above Blog boxes so user can sort by category by just single click.",'presentup'),
			"param_name"  => "sortable",
			"value"       => array(
		...
		array(
			...
			"description" => esc_attr__("Show pagination links below blog boxes.",'presentup'),
		...
		array(
			"type"        => "checkbox",
			"heading"     => esc_attr__("From Category", "presentup"),
			"description" => esc_attr__("If you like to show posts from selected category than select the category here.", "presentup") . esc_attr__("The brecket number shows how many posts there in the category.", "presentup"),
			"param_name"  => "category",
			"value"       => $catList,
		),
		array(
		...
		array(
			...
			"holder"      => "div",
			"class"       => "",
			"heading"     => esc_attr__("Show Posts",'presentup'),
			"description" => esc_attr__("How many post you want to show.",'presentup'),
			"param_name"  => "show",
			"value"       => array(
		...
		array(
			...
			"holder"      => "div",
			"class"       => "",
			"heading"     => esc_attr__("Blogbox Design",'presentup'),
			"description" => esc_attr__("Select Blogbox design.",'presentup'),
			"param_name"  => "view",
...
vc_map( array(
	"name"     => esc_attr__('ThemetechMount Blog Box','presentup'),
	"base"     => "tm-blogbox",
	"class"    => "",
